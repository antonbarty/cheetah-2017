...
pro autorun
	...
	h5dir = '/reg/d/psdm/cxi/cxi76713/scratch/hdf5/'
	xtcdir = '/reg/d/psdm/cxi/cxi76713/xtc/'
	command = '/reg/d/psdm/cxi/cxi76713/scratch/process/process'
	...
	while 1 do begin
		...
		for run = lastrun+1, lastxtcrun do begin
			...
			cmnd = command + string(nextrun) + ' process.ini ' 
			;cmnd = command + ' mimi.ini ' + nextrunstr
