...
void cheetahUpdateGlobal(cGlobal *global, cEventData *eventData){
   ...
   /* if (eventData->TimeToolDelay != 0) {
         global->TimeToolDelay = eventData->TimeToolDelay;
    }*/    
