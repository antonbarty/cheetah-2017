#ifndef Cspad_ConfigV4_hh
#define Cspad_ConfigV4_hh
  ...
  namespace CsPad
  {
    ...
    class ConfigV4
    {
      public:
        ...
        ConfigV2QuadReg*                 quads        ()       { return _quads; }
        const ConfigV2QuadReg*           quads        () const { return _quads; }
      ...
      private:
        ...
        uint32_t                  _quadMask;
        uint32_t                  _roiMask;
        ConfigV2QuadReg           _quads[MaxQuadsPerSensor];
    };
